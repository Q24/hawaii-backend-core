...
public class FileDownloadResponseLogger implements ResponseLogger<FileDownload> {
    @Override
    public void logResponse(final LogManager logManager, final Response<FileDownload> response) {
