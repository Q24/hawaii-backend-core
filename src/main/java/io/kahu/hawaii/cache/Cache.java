...
public interface Cache<T> {
    ...
    /**
     * Returns a previously-stored object, nor null if key not found.
     *
     * @param key
     *            the key of the cache entry
     * @param type
     ...
     *             in case object cannot be cast to type T
     */
    public <E> E get(String key, Class<E> type) throws CacheServiceException, ClassCastException;
     ...
     *             in case of any error
     */
    public void put(String key, T value) throws CacheServiceException;
     ...
     *             in case of any error
     */
    public void put(String key, int expiration, T object) throws CacheServiceException;
